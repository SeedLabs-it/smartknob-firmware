...
#define PB_Knob_motorCalibrated_tag              3
#define PB_Knob_strainCalibrated_tag             4
...
X(a, STATIC,   SINGULAR, BOOL,     motorCalibrated,   3) \
X(a, STATIC,   SINGULAR, BOOL,     strainCalibrated,   4)
