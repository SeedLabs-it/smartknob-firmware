...
typedef struct _PB_SpotifyConfig {
    uint32_t version;
    char base64_id_and_secret[129];
    char access_token[513];
    char token_type[65];
    char scope[129];
    uint32_t expires_in;
...
#define PB_SpotifyConfig_version_tag             1
#define PB_SpotifyConfig_base64_id_and_secret_tag 2
#define PB_SpotifyConfig_access_token_tag        3
#define PB_SpotifyConfig_token_type_tag          4
#define PB_SpotifyConfig_scope_tag               5
...
#define PB_SpotifyConfig_FIELDLIST(X, a) \
X(a, STATIC,   SINGULAR, UINT32,   version,           1) \
X(a, STATIC,   SINGULAR, STRING,   base64_id_and_secret,   2) \
X(a, STATIC,   SINGULAR, STRING,   access_token,      3) \
X(a, STATIC,   SINGULAR, STRING,   token_type,        4) \
...
extern const pb_msgdesc_t PB_SpotifyConfig_msg;
...
#define PB_SpotifyConfig_fields &PB_SpotifyConfig_msg
