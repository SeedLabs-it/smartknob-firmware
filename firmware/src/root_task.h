...
public:
    RootTask(const uint8_t task_core, MotorTask &motor_task, DisplayTask *display_task, LvglTask *lvgl_task, WifiTask *wifi_task, MqttTask *mqtt_task, LedRingTask *led_ring_task, SensorsTask *sensors_task);
    virtual ~RootTask();
