...
#ifndef LV_ATTRIBUTE_IMG_X40_LIGHT_OUTLINE
#define LV_ATTRIBUTE_IMG_X40_LIGHT_OUTLINE
#endif

const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_X40_LIGHT_OUTLINE uint8_t x40_light_outline_map[] = {
...
const lv_img_dsc_t x40_light_outline = {
