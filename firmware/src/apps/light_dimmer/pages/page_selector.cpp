...
{
    //     selector_label = lv_label_create(page);
    //     lv_label_set_text(selector_label, "Selector");
    //     lv_obj_align(selector_label, LV_ALIGN_CENTER, 0, 0);
    ...
    // selector_ = lv_obj_create(page);
    // lv_obj_align_to(selector_, hue_picker_label_, LV_ALIGN_OUT_TOP_MID, 0, -6);
    // lv_obj_set_size(selector_, 20, 20);
    // lv_obj_set_style_bg_color(selector_, LV_COLOR_MAKE(0xFF, 0x00, 0xFF), LV_PART_MAIN);
