...
OnboardingFlow::OnboardingFlow()
{
    ...
    lv_obj_set_style_bg_color(main_screen, LV_COLOR_MAKE(0x00, 0x00, 0x00), 0);
    lv_obj_set_size(main_screen, LV_HOR_RES, LV_VER_RES);

    lv_obj_t *circle = drawCircle(main_screen, 12);
    lv_obj_align(circle, LV_ALIGN_BOTTOM_MID, 0, -12);
    lv_obj_set_style_bg_color(circle, LV_COLOR_MAKE(0x80, 0xFF, 0x50), 0);

    lv_obj_t *circle2 = drawCircle(main_screen, 12);
    lv_obj_align(circle2, LV_ALIGN_BOTTOM_MID, -12, -12 * 2);
    lv_obj_set_style_bg_color(circle2, LV_COLOR_MAKE(0xD9, 0xD9, 0xD9), 0);

    lv_obj_t *circle3 = drawCircle(main_screen, 12);
    lv_obj_align(circle3, LV_ALIGN_BOTTOM_MID, 12, -12 * 2);
    lv_obj_set_style_bg_color(circle3, LV_COLOR_MAKE(0xD9, 0xD9, 0xD9), 0);

    screen_mgr.add_screen(WELCOME, new WelcomeScreen(main_screen));
    screen_mgr.add_screen(HASS, new HassScreen(main_screen));
    // screen_mgr.add_screen(WIFI, new WiFiScreen(main_screen));
    screen_mgr.add_screen(DEMO, new DemoScreen(main_screen));
    screen_mgr.add_screen(ABOUT, new AboutScreen(main_screen));

    // Show Screen 1
    screen_mgr.show_screen(WELCOME);
...
// OnboardingFlowPage getEnum(uint8_t screen)
// {
//     switch (screen)
//     {
//     case WELCOME:
...
EntityStateUpdate OnboardingFlow::updateStateFromKnob(PB_SmartKnobState state)
{
    if (current_position != state.current_position)
    {
        ...
        screen_mgr.show_screen(current_position);
        // indicatorDots();
...
// void OnboardingFlow::welcomeScreenInit()
// {
//     screens[WELCOME] = lv_obj_create(main_screen);
//     lv_obj_set_size(screens[WELCOME], LV_HOR_RES, LV_VER_RES);
...
// {
//     screens[HASS] = lv_obj_create(main_screen);
//     lv_obj_set_size(screens[HASS], LV_HOR_RES, LV_VER_RES);

//     lv_obj_t *label = lv_label_create(screens[HASS]);
//     lv_label_set_text(label, "Home Assistant Integration");
//     lv_obj_align(label, LV_ALIGN_CENTER, 0, 0);
// }

// void OnboardingFlow::wifiScreenInit()
// {
//     screens[WIFI] = lv_obj_create(main_screen);
//     lv_obj_set_size(screens[WIFI], LV_HOR_RES, LV_VER_RES);

//     lv_obj_t *label = lv_label_create(screens[WIFI]);
//     lv_label_set_text(label, "WiFi Configuration");
//     lv_obj_align(label, LV_ALIGN_CENTER, 0, 0);
// }

// void OnboardingFlow::demoScreenInit()
// {
//     screens[DEMO] = lv_obj_create(main_screen);
//     lv_obj_set_size(screens[DEMO], LV_HOR_RES, LV_VER_RES);

//     lv_obj_t *label = lv_label_create(screens[DEMO]);
//     lv_label_set_text(label, "Demo Mode");
//     lv_obj_align(label, LV_ALIGN_CENTER, 0, 0);
// }

// void OnboardingFlow::aboutScreenInit()
// {
//     screens[ABOUT] = lv_obj_create(main_screen);
//     lv_obj_set_size(screens[ABOUT], LV_HOR_RES, LV_VER_RES);

//     lv_obj_t *label = lv_label_create(screens[ABOUT]);
