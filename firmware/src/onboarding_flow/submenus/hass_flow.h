...
enum HassOnboardingPages
{
    ...
    CONTINUE_IN_BROWSER_MQTT_PAGE = 0,
    CONNECTING_TO_MQTT_PAGE,
    HASS_ONBOARDING_PAGE_COUNT,
    HASS_LOADING_PAGE
};

class HassLoadingPage : public BasePage
{
public:
    HassLoadingPage(lv_obj_t *parent) : BasePage(parent)
    {
...
public:
    ...
    {
        add(HASS_LOADING_PAGE, new HassLoadingPage(parent));
