...
public:
    WelcomePage(lv_obj_t *parent) : BasePage(parent)
    {
        ...
        lv_obj_align(img, LV_ALIGN_CENTER, 0, -56);
...
public:
    HassPage(lv_obj_t *parent) : BasePage(parent)
    {
        ...
        // lv_obj_t *img = lv_img_create(page);
        // LV_IMAGE_DECLARE(hass_logo);
        // lv_img_set_src(img, &hass_logo); // seedlabs_logo should be a C array generated by the LVGL image converter
        // lv_obj_set_width(img, hass_logo.header.w);
        // lv_obj_set_height(img, hass_logo.header.h);
